...
# Config paths
# -----------------------------
input_file <- "OG0000195_clean2_Myo2_mafft_80trim"
...
tree_file <- file.path(tree_dir,"Char_septins_mafft_septin.treefile")
tree_file <- file.path(tree_dir,"Char_septins_mafft_80trim.treefile")
